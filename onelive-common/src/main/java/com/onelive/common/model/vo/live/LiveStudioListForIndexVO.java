...
@Data
@ApiModel
public class LiveStudioListForIndexVO {
...
//	@ApiModelProperty("贡献列表")
//	List<LiveUserDetailVO> contributeList;


//	public void setStudioBackground(String studioBackground) {
//		this.studioBackground = AWSS3Util.getAbsoluteUrl(studioBackground);
//	}

	public void setStudioThumbImage(String studioThumbImage) {
		this.studioThumbImage = AWSS3Util.getAbsoluteUrl(studioThumbImage);
	}
}