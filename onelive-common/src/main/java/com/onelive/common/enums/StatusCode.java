...
public enum StatusCode {
    ...
    SYSTEM_ERROR_2(888, "系统错误，请联系管理员！"),
    BUSINESS_ERROR(550, "操作失败"),
    PARAM_ERROR(551, "参数有误，请检查!"),
    IP_ERROR(552, "请联系管理员添加服务白名单"),
    SYS_DATA_IS_DEL(402, "该数据已删除!"),
    SYS_DATA_NOT_FOUND(404, "找不到该数据!"),
    ...
    EGISTER_BLANK_NEW_PASSWORD(1009, "请输入新密码"),
    PLATFORM_REGISTER_CLOSE(1010, "当前平台关闭注册"),
    AVATAR_LEVELNOT_ENOUGH(1011, "当前等级不足，不可以修改头像"),
    REGISTER_BLANK_IMGLOGO(1213, "请填写图片标识"),
    ...
    REGISTER_COUNTRY_NOT_ALLOW_CHANGE(100805, "不可更改区域,请联系管理员"),
    ...
    LOGIN_RESET_WAY(101202, "账号已经绑定手机，请进行使用手机号登录"),
    ...
    UNUSE_GIFT_STATUS(1164, "当前可赠送礼物不存在"),
    KICKING_CANT_SELF(1165, "自己不能踢自己"),
    KICKING_CANT_ANCHOR(1166, "主播不能被踢"),
    KICKING_CANT_SUPERAMDIN(1167, "超级管理员不能被踢！"),
    BARRAGE_LEVEL_INSUFFICIENT(1168, "用户未达到发送弹幕的等级"),
    PROCESSING(1170, "正在处理中"),
    LIVE_STUDIO_CLOSE_FAIL(1171, "关播失败，请联系管理员"),
    LIVE_GIFT_GIVING_FAIL(1172, "送礼异常，请联系管理员"),
    LIVE_GIFT_BARRAGE_FAIL(1173, "发送弹幕异常，请联系管理员"),
    LIVE_GIFT_NOT_TOURIST(1174, "游客不可送礼，请先注册"),
    FAIL_MEM_GOLD_CHANGE(1175, "用户金币换银豆失败，请联系管理员"),
...
//    UPDATE_BET_ORDER_ERROR(1024, "更新注单状态异常"),
    ...
    PHONE_AREACODE_NOT_USE(2010, "手机区号不可用"),
    ...
    NICK_NAME_KILL_ILLEGAL(500112,"昵称包含不合法字符"),

    //多语言相关
    LANG_ZH_NULL_ERROR(60001, "中文内容不能为空!"),
    LANG_EN_NULL_ERROR(60002, "英文内容不能为空!"),

    //第三方游戏相关
    GAME_LOGIN_FAILURE(80001,"登陆游戏失败!"),
    GAME_TYPE_UNSUPPORT(80002,"不支持的游戏类型"),
    GAME_ACCOUNT_NOT_FOUND(80003,"没有找到游戏账号"),
    GAME_WALLET_INIT_FAILURE(80004,"游戏钱包初始化失败"),

    //提现订单正在处理中，或者已处理完成，无法取消提现,
    WITHDRAW_CANCEL_ERROR(9010, "提现订单正在处理中，或者已处理完成")
    ;
