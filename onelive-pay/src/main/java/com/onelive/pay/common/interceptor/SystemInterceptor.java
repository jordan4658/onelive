package com.onelive.pay.common.interceptor;
...
public class SystemInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws IOException {
        ...
        //获取当前app使用的国家地区
        LoginInfoUtil.setCountryCode(user.getRegisterCountryCode());
        ...
        try {
            ...
            if (renewalRecord == null) {
                ...
                if (ApiBusinessRedisUtils.isExistCurrentDayKey(RedisKeys.APP_ACTIVETOKEN, token)) {
                    ...
                    ApiBusinessRedisUtils.setRenewalToken(token, account);
                    //TODO 临时加入，后期去掉
                    ApiBusinessRedisUtils.isExistCurrentDayKey(RedisKeys.APP_ACTIVETOKEN_ACCOUNT, account);
                }
            }
        } catch (Exception e) {
