...
import com.onelive.pay.service.MemGoldchangeService;
...
public class MemGoldchangeServiceImpl extends ServiceImpl<MemGoldchangeMapper, MemGoldchange> implements MemGoldchangeService {
    ...
    @Override
    public List<MemGoldchange> getUserChangeLog(List<Integer> transactionTypes, String userAccount, Integer pageSize, Date queryDate, Date startDate) {
        return slaveMemGoldchangeMapper.getUserChangeLog(transactionTypes,userAccount,pageSize,queryDate,startDate);
    }

    @Override
    public List<TotalUserIncomeAndExpensesDTO> totalUserIncomeAndExpenses(List<String> listDate, List<Integer> transactionTypes, String userAccount) {
        return slaveMemGoldchangeMapper.totalUserIncomeAndExpenses(listDate, transactionTypes, userAccount);
    }
