...
public interface LiveGiftLogService extends IService<LiveGiftLog> {
	 ...
	 * @return
	 */
	List<RankingVo> anchorTodayRanking(boolean isPrevious, boolean isShowfans);
	 ...
	 * @return
	 */
	List<RankingVo> anchorWeekRanking(boolean isPrevious, boolean isShowfans);
	 ...
	 * @return
	 */
	List<RankingVo> anchorMonthRanking(boolean isPrevious, boolean isShowfans);
